...
/**
 * @vue/test-utils v2.0.0-beta.8
 * (c) 2020 Lachlan Miller
 * Released under the MIT License
 */

import * as vue from 'vue';
import { nextTick, getCurrentInstance, transformVNodeArgs, Transition, defineComponent, TransitionGroup, h, reactive, createApp } from 'vue';
...
var VueWrapper = /** @class */ (function () {
    function VueWrapper(app, vm, setProps, functionalEmits) {
        this.__app = app;
        this.rootVM = vm.$root;
        this.componentVM = vm;
...
function createWrapper(app, vm, setProps, functionalComponentEmits) {
    return new VueWrapper(app, vm, setProps, functionalComponentEmits);
}
